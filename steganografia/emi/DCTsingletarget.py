...
if __name__ == "__main__":
    cover_image_path = 'lena.png'      # Immagine cover 512x512 in scala di grigi
    secret_image_path = '../../mark.png'    # Immagine segreta (di qualsiasi dimensione, verrà ridimensionata a 32x32)
