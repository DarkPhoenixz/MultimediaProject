...
def morphological_cleanup(bin_img, radius=1):
    """
    ...
    bin_bool = (bin_img > 0)
    selem = disk(radius)
    cleaned_bool = opening(bin_bool, selem)
...
if __name__ == "__main__":
    ...
    secret_extracted_clean = morphological_cleanup(secret_extracted_otsu, radius=1)
